    ...
    public partial class Initial3 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "ServiceBookingContact",
                columns: table => new
                {
                    ServiceBookingId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                        .Annotation("SqlServer:IsTemporal", true)
                        .Annotation("SqlServer:TemporalHistoryTableName", "ServiceBookingContactHistory")
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceBookingContact", x => x.ServiceBookingId);
                    table.ForeignKey(
                        name: "FK_ServiceBooking_ServiceBookingContact",
